...
namespace SmartE
{
    public partial class WebForm16 : System.Web.UI.Page
    {
        ...
        private void GetBarDataForVotingName()
        {
            ...
            using (SqlConnection connection = new SqlConnection(cs))
            {
                SqlCommand cmd = new SqlCommand("Select PollName, Count(Candidate_name) as Results from tblResults group by PollName, Candidate_Name Order by Results asc", connection);
